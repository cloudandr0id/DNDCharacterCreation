<html lang="en" dir="ltr">
  ...
  <body>
    <p id="Title">
      Welcome to our DND Character Constructor!
    </p>
    <p id="Paragraph">
      To get started, please create an account with the login button!
    </p>
    <p id="Paragraph">
      If you have never played DND before,
      <a href="https://www.youtube.com/watch?v=lWhySS2mJgk&ab_channel=TabletopTerrors">
      watch this video.</a>
      It has some really good advice about character creation, as well as
      conceptualizing DND as a whole!
    </p>
  </body>
</html>
